...
## 阅读顺序
1. [当前进度](progress/PROG-20260906.md)
...
5. [V3 intake 与 Phase 4R 下游契约缺口](bugs/BUG-20260906-01-v3-phase4r-downstream-contract-gap.md)
6. [FactBindingRequest 3.0.0 intake 升级需求](requirements/REQ-20260906-03-fact-binding-v3-intake.md)
7. [FactBindingRequest 3.0.0 intake 权威边界](decisions/BIZ-20260906-02-fact-binding-v3-authority-boundary.md)
8. [FactBindingRequest 3.0.0 intake 设计与实施计划](architecture/DEV-20260906-03-fact-binding-v3-intake.md)
9. [真实上游交接与端到端候选证据闭环需求](requirements/REQ-20260906-02-real-upstream-handoff-evidence-loop.md)
10. [Agent 1、metadataReview、SqlBot 与运维责任边界](decisions/BIZ-20260906-01-agent1-metadata-review-sqlbot-boundary.md)
11. [端到端真实候选证据编排设计与实施计划](architecture/DEV-20260906-02-real-handoff-evidence-loop-orchestration.md)
12. [V2 候选模板 MongoDB 持久化需求](requirements/REQ-20260906-01-v2-candidate-persistence.md)
13. [V2 候选模板 MongoDB 持久化设计](architecture/DEV-20260906-01-v2-candidate-persistence.md)
14. [Phase 5 受限 SQL Server 验证需求](requirements/REQ-20260905-01-restricted-sqlserver-validation.md)
15. [Phase 5 受限验证边界决策](decisions/BIZ-20260905-01-restricted-sqlserver-validation-boundary.md)
16. [Phase 5 受限验证设计与实施计划](architecture/DEV-20260905-01-restricted-sqlserver-validation.md)
17. [私有字段映射与来源资料索引](reference/local-candidate-evidence/README.md)
18. [本地资料私有整合需求](requirements/REQ-20260828-03-local-candidate-evidence-integration.md)
19. [本地候选证据与 Git 可见性边界](decisions/BIZ-20260828-03-local-candidate-evidence-boundary.md)
20. [私有本地参考资料包设计](architecture/DEV-20260828-03-local-candidate-evidence-package.md)
21. [SQL AST 与安全门禁](requirements/REQ-20260827-01-sql-ast-safety-gate.md)
22. [SQL AST 与安全门禁设计](architecture/DEV-20260827-01-sql-ast-safety-gate.md)
23. [RuleReader 不可变事实交接只读接入](requirements/REQ-20260828-02-rulereader-handoff-read-intake.md)
24. [不可变事实交接只读边界](decisions/BIZ-20260828-02-rulereader-handoff-read-boundary.md)
25. [不可变事实交接只读接入设计](architecture/DEV-20260828-02-rulereader-handoff-read-intake.md)
26. [V2 SQL 候选生成输入对齐](requirements/REQ-20260828-01-v2-candidate-generation-input.md)
27. [V2 SQL 候选生成权威与不可执行边界](decisions/BIZ-20260828-01-v2-candidate-authority-boundary.md)
28. [V2 SQL 候选生成输入对齐设计](architecture/DEV-20260828-01-v2-candidate-generation-input.md)
29. [Phase 2G 项目上下文与受治理元数据授权解析](requirements/REQ-20260827-03-project-context-metadata-resolution.md)
30. [项目上下文、元数据快照与物理授权边界](decisions/BIZ-20260827-02-project-metadata-authorization-boundary.md)
31. [Phase 2G 项目上下文与受治理元数据解析设计](architecture/DEV-20260827-03-project-context-metadata-resolution.md)
32. [RuleReader FactBindingRequest 2.0.0 接入与阻断分析](requirements/REQ-20260827-02-rulereader-fact-binding-v2-intake.md)
33. [V2 权威与授权边界](decisions/BIZ-20260827-01-fact-binding-v2-authority-boundary.md)
34. [V2 consumer 与阻断分析设计](architecture/DEV-20260827-02-fact-binding-v2-readiness.md)
35. [DeepSeek 单事实 SQL 候选生成](requirements/REQ-20260826-04-deepseek-sql-candidate-generation.md)
36. [DeepSeek 候选生成设计](architecture/DEV-20260826-04-deepseek-sql-candidate-generation.md)
37. [真实 RuleReader 最新规则版本接入](requirements/REQ-20260826-03-rulereader-latest-rule-integration.md)
38. [路线图](ROADMAP.md)
...
- [BIZ-20260906-02：FactBindingRequest 3.0.0 intake 权威边界](decisions/BIZ-20260906-02-fact-binding-v3-authority-boundary.md)
- [REQ-20260906-02：真实上游交接与端到端候选证据闭环](requirements/REQ-20260906-02-real-upstream-handoff-evidence-loop.md)
- [BIZ-20260906-01：Agent 1、metadataReview、SqlBot 与运维责任边界](decisions/BIZ-20260906-01-agent1-metadata-review-sqlbot-boundary.md)
- [REQ-20260906-01：V2 候选模板 MongoDB 持久化](requirements/REQ-20260906-01-v2-candidate-persistence.md)
- [REQ-20260905-01：受限 SQL Server 验证](requirements/REQ-20260905-01-restricted-sqlserver-validation.md)
- [BIZ-20260905-01：受限 SQL Server 验证边界](decisions/BIZ-20260905-01-restricted-sqlserver-validation-boundary.md)
...
- [DEV-20260906-01：V2 候选模板 MongoDB 持久化设计](architecture/DEV-20260906-01-v2-candidate-persistence.md)
- [DEV-20260905-01：受限 SQL Server 验证设计与实施计划](architecture/DEV-20260905-01-restricted-sqlserver-validation.md)
- [PROG-20260906：Phase 5A 受限 SQL Server 描述验证实现](progress/PROG-20260906.md)
